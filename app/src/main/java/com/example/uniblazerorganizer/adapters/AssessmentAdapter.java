...
import com.example.uniblazerorganizer.AddAssessmentActivity;
...
public class AssessmentAdapter extends RecyclerView.Adapter<AssessmentAdapter.AssessmentViewHolder> {
    ...
    private final OnAssessmentDeletedListener deletedListener;
    ...
    private void confirmAndDelete(Context context, Assessment assessment) {
        new AlertDialog.Builder(context).setTitle("Delete Assessment").setMessage("Are you sure you want to delete this assessment?").setPositiveButton("Delete", (dialog, which) -> {
            // Delete from DB
